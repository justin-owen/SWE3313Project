...
William: As you can see we have Justin and I primarily on the front end of the software, that's the web page design with all the buttons, colors, and other bells and whistles. Pierre and Antonio are gonna be our back end guys, which will focus on all the storage and the math. These are very loose roles,