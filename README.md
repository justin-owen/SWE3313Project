...
Our project will be an e-commerce site built with ASP.NET Core Blazor, with the data being stored with  that sells used cars. Data will be stored via SQLite 